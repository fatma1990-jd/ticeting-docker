...
//    @PreAuthorize("hasAuthority('Manager')")
    ...
    public void deleteByProjectCode(@PathVariable("projectCode") String projectCode){
...
//    @PreAuthorize("hasAuthority('Employee')")
    ...
    public List<TaskDTO> listAllByProjectCode(@PathVariable("projectCode") String projectCode){
        List<TaskDTO> tasks = taskService.listAllByProjectCode(projectCode);
        return tasks;
    }
